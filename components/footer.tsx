...
export default function Footer() {
  return (
    <footer className='w-full lg:border-t lg:border-gray-700 bg-[#090400] dark:bg-background'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-12 pt-14 pb-20 max-w-md mx-auto md:max-w-xl lg:max-w-full'>
          <div className='block'>
            <h4 className='text-xl text-white font-bold mb-7'>Boilerplate</h4>
        ...
        <div className='py-7 border-t border-gray-700'>
          <div className='flex items-center justify-center flex-col lg:space-y-0 space-y-8 lg:justify-between lg:flex-row'>
            <Link href='https://pagedone.io/' className='flex justify-center '>
              <span className='items-center text-white font-bold flex gap-2'>
                <Torus className='text-primary to-primary bg-clip-text text- w-10 h-10' />
                Boilerplate
              </span>
            </Link>
            <span className='text-xs text-gray-400 block'>
              ©<Link href='https://pagedone.io/'>pagedone</Link> 2024, All
              rights reserved.
            </span>
